        		...
        		<div class="row">
        			<div class="col-md-12">
        				<ul class="list-group">	
        					...
        					<!--  anna  -->
        					<li class="list-group-item">
        					<b><a href="<%=request.getContextPath()%>/administrador/BandeiradaCRUD?cmd=listar">UC008 - Gerenciar Bandeirada</a></b>
        					</li>
        					
        					<li class="list-group-item">
        					<b><a href="<%=request.getContextPath()%>/cliente/ClienteCRUD?cmd=listarcli">UC009 - Cadastrar cliente<br></a></b>
        					</li>    
